...
```{r}
cat("Number of non-zero coefficients including the intercept:", sum(predict(lasso_model, type="coefficients", s=best_lasso_lambda) != 0), "\n")
```
...
```{r}
cat("Number of non-zero coefficients including the intercept:", sum(predict(lasso_model2, type="coefficients", s=best_lasso_lambda2) != 0), "\n")
```
